  ...
  return (
    <div className="max-w-[1400px] mx-auto px-6 py-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5">
        ...
        <button
          className={`btn w-full sm:w-auto ${showAddForm ? 'btn-primary' : 'btn-secondary'} rounded-lg`}
      ...
      <div className="card p-5 mb-5 border-none shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          ...
          <div className="flex flex-wrap items-center gap-1.5 bg-paper p-1 rounded-lg w-full sm:w-auto">
            {['All', 'Active', 'Inactive'].map(s => (
              <button
                key={s}
                className={`flex-1 sm:flex-none px-4 py-1.5 text-[13px] font-medium rounded-md transition-colors ${statusFilter === s ? 'bg-panel text-navy shadow-sm' : 'text-navy/50 hover:text-navy hover:bg-panel/50'}`}
      ...
      {/* Patient Table */}
      <div className="card border-none shadow-card">
